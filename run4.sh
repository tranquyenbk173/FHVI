...
#SBATCH --output=/home/quyentt15/quyentt15/Bayesian_finetuning/sbatch/mbpp%A.out # create a output file
#SBATCH --error=/home/quyentt15/quyentt15/Bayesian_finetuning/sbatch/mbpp%A.err # create a error file
