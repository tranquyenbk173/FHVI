...
#SBATCH --job-name=patch_camelyon_deepEns # create a short name for your job
...
# Run Python script
python main.py fit --config configs/lora/vtab_patch_camelyon-r16-lr0.05_deepEns.yaml
